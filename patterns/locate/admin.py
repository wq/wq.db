...
class LocationInline(generic.GenericTabularInline):
    ...
    def formfield_for_dbfield(self, db_field, **kwargs):
        if isinstance(db_field, models.GeometryField):
            ...
            kwargs['widget'] = self.admin_site._registry.get(self.parent_model).get_map_widget(db_field)
            return db_field.formfield(**kwargs)
        else:
            return super(LocationInline, self).formfield_for_dbfield(db_field, **kwargs)
